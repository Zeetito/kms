...
<div class="modal fade" id="submitAttendanceModal" tabindex="-1">
  <div class="modal-dialog">
    <form id="submitAttendanceForm" method="POST" action="{{ route('submit.attendance') }}">
        @csrf
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                Are you sure you want to submit attendance for selected users?
            </div>
